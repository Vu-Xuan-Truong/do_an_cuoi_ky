...
namespace webHD.Areas.Admin.Controllers
{
        ...
        
    {
        ...
        public ActionResult Create()
        {
            ...
            var hdhselected = new SelectList(db.Danhmucsanphams, "MaDM", "TenDM");
            ViewBag.MaDM = hdhselected;
            return View();
        }
        ...
        public ActionResult Edit(int id)
        {
            ...
            ViewBag.MaNCC = hangselected;
            var hdhselected = new SelectList(db.Danhmucsanphams, "MaDM", "TenDM",dt.MaDM);
            ViewBag.MaDM = hdhselected;
           // 
            return View(dt);
